...
WARNING: Resolve-SystemNetWebRequest: For troubleshooting steps see: https://eucpilots.com/evergreen/troubleshoot/.
VERBOSE: Get-Zoom: Setting fallback URL to: https://eucpilots.com/evergreen/issues/.
